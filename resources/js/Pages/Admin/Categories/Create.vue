            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <h1 class="text-2xl font-bold mb-6">Dodaj novu kategoriju</h1>

                        <form @submit.prevent="form.post(route('admin.categories.store'), {
                            onSuccess: () => {
                                // Prisili reload index stranice sa svežim podacima
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Opis (opcionalno)</label>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label class="ml-2 block text-sm text-gray-900">Aktivna kategorija</label>
                                </div>
